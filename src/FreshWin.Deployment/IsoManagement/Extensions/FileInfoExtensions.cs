...
namespace FreshWin.Deployment.IsoManagement.Extensions
{
    public static class FileInfoExtensions
    {
        ...
        public static void ExtractIsoToDirectory(this FileInfo isoPath, DirectoryInfo destinationPath, IProgress<IsoExtractionProgress>? progress = null)
        {
            if (!isoPath.Exists)
            {
            ...
            IsoExtraction.Extract(isoPath.FullName, destinationPath.FullName, progress);
        }
    }
}
